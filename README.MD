...
alarm clock that uses a simple GUI interface. I am presented with the following 
task: write a function that takes an alarm time from a user and plays a 
random video once the alarm time is reached.
